...
class frame_main ( wx.Frame ):
	...
	def init(self):
		...
		self.bitmap_logo = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap(f"{path}\\assets\\logo.png", wx.BITMAP_TYPE_ANY),
		...
		self.staticText_projectname.SetFont(
			wx.Font(44, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Righteous"))
		...
		self.searchCtrl_moviesearch = wx.SearchCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
													0 | wx.BORDER_SIMPLE)
		...
		self.searchCtrl_moviesearch.SetFont(
			wx.Font(20, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Righteous"))
		...
		self.button_suprise = wx.ToggleButton(self, wx.ID_ANY, u"" + LANGF["surprise_me"][LANG], wx.DefaultPosition,
											  wx.DefaultSize, wx.BORDER_NONE)
		self.button_suprise.SetValue(True)
		self.button_suprise.SetFont(
			wx.Font(20, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Righteous"))
		...
		self.button_home = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
		...
		self.button_watchlist = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
												wx.BU_AUTODRAW | wx.BORDER_NONE)
		...
		self.button_like = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
										   wx.BU_AUTODRAW | wx.BORDER_NONE)
		...
		self.button_settings = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
											   wx.BU_AUTODRAW | wx.BORDER_NONE)
	...
	def __init__( self, parent ):
		wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"F E A", pos=wx.DefaultPosition, size=wx.Size(1440, 1024),
